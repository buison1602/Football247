...
namespace Football247.Infrastructure.Migrations
{
    ...
    [Migration("20260612020757_add_CreatedDate_to_ApplicationUser")]
    partial class add_CreatedDate_to_ApplicationUser
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Football247.Domain.Entities.Stores.Cart", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier")
            ...
            modelBuilder.Entity("Football247.Domain.Entities.Stores.CartItem", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier")
            ...
            modelBuilder.Entity("Football247.Domain.Entities.Stores.Order", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier")
            ...
            modelBuilder.Entity("Football247.Domain.Entities.Stores.OrderItem", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier")
            ...
            modelBuilder.Entity("Football247.Domain.Entities.Stores.Product", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier")
            ...
            modelBuilder.Entity("Football247.Domain.Entities.Stores.ProductCategory", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier")
            ...
            modelBuilder.Entity("Football247.Domain.Entities.Stores.CartItem", b =>
                {
                    b.HasOne("Football247.Domain.Entities.Stores.Cart", "Cart")
                        .WithMany("CartItems")
                        .HasForeignKey("CartId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("Football247.Domain.Entities.Stores.Product", "Product")
                        .WithMany("CartItems")
            ...
            modelBuilder.Entity("Football247.Domain.Entities.Stores.OrderItem", b =>
                {
                    b.HasOne("Football247.Domain.Entities.Stores.Order", "Order")
                        .WithMany("OrderItems")
            ...
            modelBuilder.Entity("Football247.Domain.Entities.Stores.Product", b =>
                {
                    b.HasOne("Football247.Domain.Entities.Stores.ProductCategory", "ProductCategory")
                        .WithMany("Products")
            ...
            modelBuilder.Entity("Football247.Domain.Entities.Stores.ProductCategory", b =>
                {
                    b.HasOne("Football247.Domain.Entities.Stores.ProductCategory", "ParentCategory")
