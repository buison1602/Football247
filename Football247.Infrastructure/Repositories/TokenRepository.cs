...
namespace Football247.Repositories
{
    public class TokenRepository : ITokenRepository
    {
        ...
        public async Task<LoginResponseModel> CreateTokensAsync(ApplicationUser user)
        {
        ...
        public async Task<LoginResponseModel> RefreshTokensAsync(string refreshToken)
        {
