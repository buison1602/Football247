...
namespace Football247.UnitTests.Controllers.Article
{
    ...
    //            {
    //                new Football247.Domain.Models.EntityModels.DTOs.Tag.TagDto { Id = Guid.NewGuid(), Name = "Tag1", Slug = "tag1" },
    //                new Football247.Domain.Models.EntityModels.DTOs.Tag.TagDto { Id = Guid.NewGuid(), Name = "Tag2", Slug = "tag2" }
    //            }
    //        };
